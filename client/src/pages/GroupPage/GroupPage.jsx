  ...
  const groupContent = (
    <div className={styles.groupContainer}>
      ...
      <ul className={styles.groupMain}>
        {[
          {
            imgSrc: "https://res.cloudinary.com/dsr6kwzrr/image/upload/v1728633396/samples/animals/three-dogs.jpg",
            title: "First Group",
          ...
          {
            imgSrc: "https://res.cloudinary.com/dsr6kwzrr/image/upload/v1728633397/samples/ecommerce/leather-bag-gray.jpg",
            title: "Second Group",
          ...
          {
            imgSrc: "https://res.cloudinary.com/dsr6kwzrr/image/upload/v1728633397/samples/imagecon-group.jpg",
            title: "Third Group",
          ...
          {
            imgSrc: "https://res.cloudinary.com/dsr6kwzrr/image/upload/v1728633405/cld-sample-2.jpg",
            title: "Fourth Group",
